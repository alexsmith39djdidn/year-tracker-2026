...
var RATING = {
  version: 'v0.4',
  date: '13.09.2026',
  window: 'неделя 07–13.09.2026 · первый срез в пересмотренной роли прибора (09.09) · неделя 31.08–06.09 пропущена целиком — инфраструктура не пустила замер',
  // Дельта к v0.4 (24–30.08 — v0.5 физически не существует, неделя 31.08–06.09
  // пропущена целиком). Формулы не менялись, кроме одной: замена источника
  // для вектора/цены движения признана постоянной — дневных снятий больше
  // не будет никогда (решение 08.09), а не «в этот раз нет».
  prev: 35,
  ...
  groups: [
    {
      ...
      scales: [
        { name: 'Продуктивность недели', value: '73 закрыто из ~100–105 задач недели', score: 73, est: true },
        { name: 'Запас хода',            value: 'неизвестен — остаток после прихода 10.09 не назван', score: null },
        { name: 'Недель без движения к деньгам', value: '2 мёртвые из 6 размеченных', score: 84, est: true }
      ]
    },
    {
      key: 'course', name: 'Действия и курс', icon: '➤',
      scales: [
        // Дневных меток 💰/🔧/⚙️ больше не будет никогда (решение 08.09) —
        // источник через Треугольник теперь постоянный, не вынужденный.
        { name: 'Вектор недели',        value: 'через Треугольник: движение 11 из 43 весов недели ≈ 26%', score: 52, est: true },
        { name: 'Расхождение сказали/сделали', value: 'не размечено', score: null },
        { name: 'Доля в ядре-20%',      value: 'не размечено', score: null },
        { name: 'Ключевых дел за неделю', value: 'нет данных по весам задач', score: null },
        { name: 'Цена движения',        value: '≈43 веса недели на 4 внешних действия', score: 93, est: true }
      ]
    },
    {
      key: 'projects', name: 'Проекты', icon: '▣',
      scales: [
        { name: 'Активных проектов',    value: '41 буквально, но 9 уже завершены и не заархивированы — формула стала ненадёжной', score: 0 },
        { name: 'Проекты без движения', value: 'не размечено', score: null },
        { name: 'Ход проектов',         value: 'средний % выполнения по активным проектам', score: 56, est: true },
        ...
        { name: 'Окупаемость заточки',  value: 'не размечено', score: null }
      ]
    },
    {
      key: 'specs', name: 'Спецы и работа', icon: '⚒',
      scales: [
        { name: 'Баланс ИИ / люди',     value: '≈63% закрытых — двумя способами счёта, сошлись', score: 100 },
        { name: '% выполнения задач',   value: '73 из ~100 задач недели', score: 73, est: true },
        { name: 'Задач в день',         value: '≈15 в день — выше коридора 5–12', score: 60, est: true },
        { name: 'Простой',              value: '4 из 11 не закрыли ни одной задачи за неделю', score: 27 },
    ...
    },
    {
      ...
      scales: [
        { name: 'Целевые совещания',    value: '8 встреч за неделю · качество по каждой не проверено', score: 55, est: true },
        { name: 'Решений с исполнителем', value: 'исполнено видимо ≥2 из ~7 решений прошлого аудита', score: 30, est: true },
        { name: 'Отклик',               value: 'учёт не заведён', score: null },
        { name: 'Тишина',               value: 'учёт не заведён', score: null }
      ]
    },
    {
      key: 'biz', name: 'Бизнес', icon: '✦',
      scales: [
        { name: 'Живые лиды',           value: 'трое — впервые больше одного', score: 60 },
        { name: 'Касаний наружу',       value: '4 подтверждённых следом за неделю', score: 40, est: true },
        { name: 'Дней с касания',       value: 'один день с последнего касания', score: 86, est: true },
        { name: 'Готовность к продаже', value: 'витрина, White Paper и прайс есть · кейса и отзыва нет', score: 60, est: true },
        { name: 'Контента вышло',       value: '1 единица · после девяти недель нуля', score: 20 },
        { name: 'Клиентов в ведении',   value: 'ни одного', score: 0 },
        { name: 'Конверсия разговоров', value: '0 продаж при нескольких разговорах', score: 0 },
        { name: 'Предложений с ценой',  value: 'двое — впервые в истории прибора ненулевое значение', score: 67, est: true }
      ]
    },
    {
      key: 'money', name: 'Финансы', icon: '₽',
      scales: [
        { name: 'Приход за месяц',      value: 'первый приход за полтора месяца', score: 15, est: true },
        { name: 'Run-rate к цели',      value: 'ноль регулярной выручки', score: 0 },
        { name: 'Запас хода',           value: 'неизвестен — остаток после прихода 10.09 не назван', score: null },
        { name: 'Учёт расходов',        value: 'перенос прежней оценки', score: 63, est: true },
        { name: 'Приход по направлениям', value: 'не размечено', score: null }
      ]
    },
    {
      key: 'system', name: 'Устройство', icon: '⚙',
      scales: [
        { name: 'Ритуалы выполнены',    value: 'вечерние сверки 4 из 7 вечеров · аудит готовится', score: 70, est: true },
        { name: 'Порядок в памяти',     value: 'колея частично пропущена, структура держится', score: 70, est: true },
        { name: 'Улучшений внедрено',   value: '≥6 за неделю: роль прибора · ритм ночи · система экспериментов · тест моделей · Колея 1.1.0 · знания к умениям', score: 100 },
        { name: 'Живых спецов',         value: 'маркетинг активен, бухгалтерия и юр — по-прежнему каркасы', score: 28, est: true },
        { name: 'Окупаемость устройства', value: 'переопределение роли ВОЛЬТЫ уже окупилось этим срезом', score: 70, est: true }
      ]
    }
  ]
};
...
var TRIANGLE = {
  version: '0.1',
  date: '13.09.2026',
  note: 'тест закрыт — Треугольник остаётся навсегда как верхний слой прибора. Неделя 31.08–06.09 пропущена в графике: данных нет физически, разметка задним числом была бы подгонкой',
  ...
  weeks: [
    ...
    {
      label: '07–13.09',
      inner: 18, better: 14, outer: 11,
      stock: 9,
      top: 'впервые: два предложения с ценой дошли до человека'
    }
  ],
  ...
  stockItems: [
    ...
    { name: 'Предложение с ценой пекарю', w: 3, since: 'с 21.08 — перенесено на встречу 21–22.09' }
  ]
};

  ...
  groups: [
    ...
    },
    {
      ...
      scales: [
        ...
        { name: 'Расхождение сказали/сделали', value: 'объявляли наружу — ушли внутрь', score: 30, est: true },
    ...
    },
    {
      ...
      scales: [
        ...
        { name: 'Баланс ИИ / люди',     value: '20% закрытых дел на ИИ, 80% на людях', score: 20 },
        { name: '% выполнения задач',   value: '25 из 50 за неделю',           score: 50 },
        { name: 'Задач в день',         value: '≈8 в день по компании',        score: 70, est: true },
    ...
    },
    {
      ...
      scales: [
        ...
        { name: 'Дней с касания',       value: 'больше недели тишины',         score: 20 },
